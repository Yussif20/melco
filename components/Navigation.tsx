  ...
  const productCategories = [
    {
      ...
      description: tProducts("categories.headShort"),
    ...
    },
    {
      ...
      description: tProducts("categories.eyeFaceShort"),
      image: "/category-headers/eye.png",
      href: `/${locale}/products/eye-and-face-protection`,
    },
    {
      key: "hearing",
      name: tProducts("categories.hearing"),
      description: tProducts("categories.hearingShort"),
    ...
    },
    {
      ...
      description: tProducts("categories.respiratoryShort"),
    ...
    },
    {
      ...
      description: tProducts("categories.handShort"),
    ...
    },
    {
      ...
      description: tProducts("categories.bodyShort"),
    ...
    },
    {
      ...
      description: tProducts("categories.footShort"),
    ...
    },
    {
      ...
      description: tProducts("categories.gasDetectorsShort"),
      image: "/category-headers/gas.jpg",
      href: `/${locale}/products/gas-detector`,
    },
  ];
