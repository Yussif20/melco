    ...
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 items-center">
          ...
          {/* Ansell */}
          <div className="group flex items-center justify-center p-8 bg-white dark:bg-white/95 rounded-xl hover:bg-gray-50 dark:hover:bg-white transition-all duration-300 shadow-sm hover:shadow-md dark:shadow-lg dark:hover:shadow-xl border border-gray-150 dark:border-gray-300/20 md:col-span-3 lg:col-span-1">
            <Image
